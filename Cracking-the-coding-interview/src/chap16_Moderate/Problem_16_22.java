 ...
 * The only input to your method is K. You should print the final grid and return nothing. The method signature might be something
 * like void printKMoves (int K). 
 */
public class Problem_16_22
{
